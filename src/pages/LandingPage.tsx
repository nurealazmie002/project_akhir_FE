  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-sky-950 to-slate-950 overflow-hidden">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 -left-40 w-96 h-96 bg-cyan-500/20 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute -bottom-40 right-1/3 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl animate-pulse delay-500" />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-sky-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-sky-500/25">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/register">
                <Button className="bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600 text-white shadow-lg shadow-sky-500/25">
                  Daftar
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-sky-400 via-cyan-400 to-cyan-400 text-transparent bg-clip-text">
                Lebih Mudah
              </span>
            </motion.h1>
            ...
            >
              <Link to="/register">
                <Button size="lg" className="w-full sm:w-auto gap-2 bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600 text-white shadow-lg shadow-sky-500/25 px-8">
                  Mulai Sekarang
                  <ArrowRight size={18} />
                </Button>
              </Link>
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-sky-600 to-cyan-600" />
            ...
            <div className="relative p-8 sm:p-12 text-center">
              ...
              <Link to="/register">
                <Button size="lg" className="bg-white text-sky-600 hover:bg-sky-50 shadow-xl px-8">
